...
export const creatorConfig: CreatorConfig = {
  ...
  username: "ikyawthaypaing",
  email: "ikyawthaypaing@gmail.com",
  ...
  portraitSketchImage: {
    ...
    alt: "Detailed portrait sketch of Kyaw Thay Paing",
  },
  socialMediaLinks: [
    {
      title: "Github",
      href: generateProfileLink("ikyawthaypaing", "github"),
      icon: "github",
    },
    {
      title: "Twitter",
      href: generateProfileLink("ikyawthaypaing", "twitter"),
      icon: "twitter",
    },
    {
      title: "LinkedIn",
      href: generateProfileLink("ikyawthaypaing", "linkedin"),
      icon: "linkedin",
    },
  ],
  services: [
